...
Every artifact that outlives the conversation — GitHub issue bodies, acceptance criteria, commit messages, code comments — reads as endorsed direction once written. Future sessions (and the architect) treat them as real planned things, and work gets scoped against the invention.
